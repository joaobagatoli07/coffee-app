    ...
    return (
        <div className='flex'>
            <section className='h-screen w-3/5'>
                <img src='src/assets/images/coffee/pages/signInImage.jpg' className='h-full w-full' alt='Imagem ilustrativa' />
            </section>
            <section className='bg-amber-950 h-screen w-2/5 flex justify-center items-center'>
                <main className='h-4/5 flex flex-col justify-center items-center'>
                    ...
                    <span className='text-lg mb-4 text-white'>Olá, seja bem vindo de volta</span>
                    <form>
                        <Input
                            type='text'
                            placeholder='Usuário'
                    ...
                    <span className='mt-2 text-sm text-white'><Link to='/Cadastro'>Criar uma conta</Link></span>
                </main>
            </section>
        </div>
    )
